...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # += is an assignment, it makes a copy in another variable each time
    # Shovel op is like concat(), it alters the receiver in-place
    # Glass analogy https://stackoverflow.com/questions/4684446/why-is-the-shovel-operator-preferred-over-plus-equals-when-building-a
  end
